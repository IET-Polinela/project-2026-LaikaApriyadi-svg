"""
Django settings for Laikaapriyadi_24782079_iet_2026 project.
...
SECRET_KEY = 'django-insecure-uib!5_5e42ac3*$btjh+@)$m4#yhr5+9hwonx()#r@(x3%472^'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.contrib.messages.context_processors.messages', # Wajib untuk Alert 
            ],
        },
    },
]
